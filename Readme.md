...
1. https://github.com/Amant-987/final_work_Intro_C_Sharp
2. см.  (название файла) (ссылка на файл в гитхабе)
3. Данный текст находится в Readme.md
4. Скомпилировать C# код из файла [(название файла) (ссылка на файл в гитхабе)
